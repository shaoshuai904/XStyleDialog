...
fun ComponentActivity.setContentViewAndSetWindowInsets(layoutResID: Int) {
    val rootView = LayoutInflater.from(this).inflate(layoutResID, null)
    setContentViewAndSetWindowInsets(rootView, null)
}

fun ComponentActivity.setContentViewAndSetWindowInsets(rootView: View) {
    setContentViewAndSetWindowInsets(rootView, null)
}
